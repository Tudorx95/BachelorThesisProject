            ...
            <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
                <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800">Simulation Options</h2>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                        <h3 className="text-lg font-semibold text-blue-900 mb-4">Federated Learning Configuration</h3>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">Total number of participating clients</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">Number of malicious clients</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">Total FL training rounds</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">Model architecture name</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-1">Client selection strategy</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">Rounds using poisoned data</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                        <h3 className="text-lg font-semibold text-red-900 mb-4">Data Poisoning Attack Parameters</h3>
                        <div className="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-1">Type of poisoning attack</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">Attack intensity (0.01-1.0)</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">% of data to poison (0.01-1.0)</p>
                            </div>
                        </div>
