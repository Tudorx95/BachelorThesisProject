...
class EnhancedFederatedServer:
    ...
    def load_base_model(self):
        try:
            # Daca rulam scriptul prima data, foloseste modelul denumit .keras. Daca rulam ultima data foloseste modelul _final.keras
            # salvat in urma rularii acestui script
...
def main():
    parser = argparse.ArgumentParser(description='Enhanced Federated Learning Simulator with JSON Metrics Storage')
